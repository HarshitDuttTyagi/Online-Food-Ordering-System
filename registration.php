	...
	elseif(mysqli_num_rows($check_email) > 0) 
     {
       echo "<script>alert('Email Already exists!');</script>"; 
        ...
        if(mysqli_query($db, $mql))
        {
            ...
            $message = "Your email is used for registering on our food ordering system.";
            $headers = "From: harshitdutttyagi@gmail.com"; // Change this to your domain
            ...
            {
                echo "<script>alert('Registration successful. However, the confirmation email could not be sent.');</script>";
            }
